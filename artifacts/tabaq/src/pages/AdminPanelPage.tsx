...
const INITIAL_MODULES: Module[] = [
  ...
  { id: 'waitlist', nameEn: 'Waitlist System', desc: 'Automated waitlist and SMS notification when tables become available', icon: Bell, color: 'bg-orange-500/10 text-orange-600', enabled: true, version: '1.0.1', dependencies: ['reservations'] },
