...
import { Star, ChevronDown, ChevronUp, Camera, Send, X } from 'lucide-react';
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          <textarea
            ...
            dir={lang === 'ar' ? 'rtl' : 'ltr'}
          />
          <p className="text-xs text-muted-foreground text-end mt-1">{text.length}/1000</p>
        </div>
        ...
        <Button type="submit" className="w-full gap-2" disabled={createReview.isPending || overall === 0}>
